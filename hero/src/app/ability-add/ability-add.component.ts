...
@Component({
    ...
    templateUrl: './ability-add.component.html',
    styleUrl: './ability-add.component.scss'
})
export default class AbilityAddComponent {
    ...
    protected abilityForm = new FormGroup({
